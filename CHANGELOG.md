## 0.1.5 (unreleased)
- Add optional backend-independent envelope encryption through `DurableServer.Backends.EncryptedStore`, with per-object content keys, multi-recipient X25519 HPKE key wrapping, ChaCha20-Poly1305 authentication, plaintext read compatibility, and storage-key binding.
